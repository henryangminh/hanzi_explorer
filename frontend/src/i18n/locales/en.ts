export default {
  translation: {
    ...
    dashboard: {
      ...
      repeatRandomHint: 'Mostly fresh cards, up to 10% are previously seen cards (learned or not)',
      repeatRepeatUnlearned: 'Review unlearned',
      repeatRepeatUnlearnedHint: 'Mostly fresh cards, up to 10% are red-marked (not learned) for review',
