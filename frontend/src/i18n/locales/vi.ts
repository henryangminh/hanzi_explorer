export default {
  translation: {
    ...
    dictionary: {
      ...
      tabResultCount: 'Hiển thị {{count}} kết quả cho từ khoá "{{query}}"',
      save: 'Lưu',
      saving: 'Đang lưu...',
      fromCache: 'từ cache',
      pinyin: 'Pinyin',
    ...
    dashboard: {
      ...
      defaultIntervalHint: 'Từ vựng của ngày được làm mới mỗi ngày, không thể thay đổi',
      errorName: 'Vui lòng nhập tên widget',
      errorCount: 'Số lượng phải lớn hơn 0',
      noWOTD: 'Bạn không có từ vựng vào ngày này',
      viewingDate: 'Đang xem: {{date}}',
      backToToday: 'Hôm nay',
      repeatMode: 'Lặp từ',
      repeatRandom: 'Lặp ngẫu nhiên',
      repeatRandomHint: 'Chủ yếu từ mới, tối đa 10% là từ đã học hoặc chưa học được lặp lại',
      repeatRepeatUnlearned: 'Ôn từ chưa học',
      repeatRepeatUnlearnedHint: 'Chủ yếu từ mới, tối đa 10% là từ đã đánh dấu đỏ (chưa học) để ôn lại',
      repeatUnlearned: 'Chỉ từ chưa học',
    ...
    flashcards: {
      title: 'Flashcards',
      progress: 'Đã học {{learned}} / {{total}} từ',
      empty: 'Chưa có flashcard nào. Thêm widget ở Trang chủ để bắt đầu.',
      learned: 'Đã học',
      unlearned: 'Chưa học',
    },
    searchHistory: {
